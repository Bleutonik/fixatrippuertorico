...
import { Home, Ship, ChefHat, Car, Heart } from "lucide-react";
...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden border-t border-border/50 bg-background/95 backdrop-blur-xl safe-bottom">
