...
const translations: Record<string, Record<Language, string>> = {
  ...
  "contact.submit": { en: "Send Request", es: "Enviar Solicitud" },
  "contact.phone": { en: "Phone (optional)", es: "Teléfono (opcional)" },
  "contact.whychoose": { en: "Why Choose Fix a Trip Puerto Rico", es: "¿Por Qué Elegir Fix a Trip Puerto Rico?" },
  "contact.why1": { en: "Personalized, human support from start to finish", es: "Atención personalizada y humana de principio a fin" },
  "contact.why2": { en: "Curated experiences, not mass tourism", es: "Experiencias curadas, no turismo masivo" },
  "contact.why3": { en: "Trusted local partners across the island", es: "Socios locales de confianza en toda la isla" },
  "contact.why4": { en: "Transparent pricing, no hidden fees", es: "Precios transparentes, sin cargos ocultos" },
  "contact.why5": { en: "One point of contact for your entire trip", es: "Un solo punto de contacto para todo tu viaje" },
